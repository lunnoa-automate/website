export const de = {
  ...
  features: {
    ...
    items: {
      ...
      knowledgeBase: {
        ...
        description: 'Versorgen Sie AI-Agents und Workflows mit Ihren Daten. Eine vektorisierte Wissensbasis ermöglicht jederzeit Zugriff auf validierte Inhalte ohne manuellen Pflegeaufwand.',
      },
    },
    integrations: {
      title: 'Integrationen.',
      subtitle: 'Sie benötigen eine eigene Integration?',
  ...
  team: {
    ...
    partners: {
      title: 'Schweizer Partnernetzwerk.',
      titleHighlight: 'Wachsend.',
      quote: '"Wir wissen selbst wie wichtig der persönliche Kontakt ist. Wir sind Ihre erste Anlaufstelle. Gern uf Schwiizerdütsch."',
      description: 'Je nach Maturitätslevel und identifizierten Implikationen bringen wir Sie mit einem Netzwerk von Top-Expertinnen und Experten zusammen, die Sie bei der Implementierung, Adoption und dem nachhaltigen Enabling von AI in Ihrer Organisation unterstützen.',
  ...
  faq: {
    ...
    subtitle: 'Finden Sie hier Antworten auf die häufigsten Fragen zu Lunnoa Automate.',
    items: [
      {
  ...
  impressum: {
    ...
    tradeRegister: 'Handelsregister-Nr.',
    tradeRegisterOffice: 'Handelsregister',
    tradeRegisterOfficeValue: 'Amtsgericht Kanton Schaffhausen',
    managingDirector: 'Vertretungsberechtigter Geschäftsführer',
    purpose: 'Firmenzweck',
    purposeValue: 'IT-Dienstleistungen, Beratung, Softwareentwicklung und Verkauf zugehöriger Produkte',
  },
