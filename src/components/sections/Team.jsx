...
const teamKeys = ['sasa', 'alessandro'];
const teamInitials = ['SK', 'AD'];
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-12">
          {teamKeys.map((key, index) => {
            const member = t.team.members[key];
            return (
              <SlideUp key={key} delay={index * 0.1}>
                <div className="relative w-[320px] h-[420px] rounded-[30px] overflow-hidden group cursor-pointer">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-primary via-secondary to-purple transition-transform duration-700 group-hover:scale-110">
                    {/* Placeholder Pattern */}
                    <div 
