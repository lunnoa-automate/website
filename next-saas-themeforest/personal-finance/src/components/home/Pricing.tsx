...
const Pricing = () => {
  return (
    <section className="dark:bg-background-6 bg-white pt-16 pb-16 md:pt-20 md:pb-20 lg:pt-[90px] lg:pb-[90px] xl:pt-[100px] xl:pb-[100px]">
      <div className="bg-background-2 dark:bg-background-5 main-container mx-4 max-w-[1460px] space-y-[70px] rounded-[20px] py-16 sm:mx-auto md:py-20 lg:px-[64px] xl:py-[120px]">
