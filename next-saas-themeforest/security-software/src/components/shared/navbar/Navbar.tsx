  ...
  return (
    <MobileMenuProvider>
      <header
        ...
        className={cn(
          'lp:!max-w-[1290px] fixed top-14 left-1/2 z-50 mx-auto w-full max-w-[350px] -translate-x-1/2 transition-all duration-500 max-md:!top-8 min-[425px]:max-w-[375px] min-[500px]:max-w-[450px] sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px]',
          isScrolled && 'top-2',
        )}>
