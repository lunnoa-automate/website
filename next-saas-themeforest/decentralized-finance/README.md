# Decentralized Finance - Next.js SaaS Template

A modern, production-ready Next.js 16 SaaS template built for decentralized finance and fintech applications. Features a complete set of pages, components, and functionality with React 19, TypeScript, Tailwind CSS 4, and cutting-edge web technologies.
...
- ✅ **40+ Pages** - Comprehensive page collection for DeFi/Fintech businesses
...
```
ns-decentralized-finance-next/
├── public/                     # Static assets
│   ├── images/                 # Images (289 files: PNG, SVG, JPG)
...
│   │   ├── authentication/     # Auth components (Login/Signup variants)
...
│   │   ├── our-serices-details/# Our services detail components
...
5. **Dark Mode**: Configured via `next-themes` in layout
...
export const metadata: Metadata = {
  ...defaultMetadata,
  title: 'New Page - Decentralized Finance || NextSaaS',
