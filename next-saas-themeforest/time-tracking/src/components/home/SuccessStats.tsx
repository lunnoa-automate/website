...
const SuccessStats = () => {
  return (
    <section
      className="bg-background-2 dark:bg-background-5 pt-16 pb-20 md:pt-20 md:pb-24 lg:pt-[110px] lg:pb-[125px] xl:pt-[140px] xl:pb-[150px]"
      aria-label="Success Metrics">
      <div className="main-container">
        <div className="mb-10 max-w-[514px] space-y-3 max-lg:mx-auto md:mb-[70px]">
        ...
        <RevealAnimation delay={0.3}>
          <div className="bg-secondary dark:bg-background-6 flex flex-col items-center justify-center gap-y-4 rounded-[12px] py-6 md:flex-row md:items-start md:gap-y-0">
            <div className="flex flex-1/3 flex-col items-center justify-center gap-6 py-[22px]">
              <div className="bg-ns-green w-fit rounded-full px-7 py-3.5">
              ...
              <h6 className="flex items-center justify-center gap-0.5 text-center text-white">
