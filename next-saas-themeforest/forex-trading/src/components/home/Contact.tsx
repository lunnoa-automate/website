...
const Contact = () => {
  return (
    <RevealAnimation delay={0.1}>
      <section className="bg-background-3 dark:bg-background-5 py-[100px]" aria-label="Contact Us">
            ...
            <RevealAnimation delay={0.4}>
              <div className="dark:bg-background-6 flex-1 rounded-[20px] bg-white p-7 md:p-[42px] lg:max-w-[605px]">
                <form action="#" method="post">
                  ...
                  <button
                    type="submit"
                    className="btn btn-secondary dark:btn-accent btn-md hover:btn-green w-full first-letter:uppercase before:content-none"
