...
const Features = () => {
  ...
  return (
    <section className="bg-background-2 dark:bg-background-5 pt-[50px] pb-[100px] md:pt-[100px] md:pb-[200px] dark:md:pb-[100px]">
      <div className="main-container">
        <div className="mb-[35px] space-y-5 text-center md:mb-[70px]">
        ...
        <div className="grid grid-cols-12 gap-y-10 md:gap-8">
          {featureGuides.map((guide, index) => (
            <RevealAnimation key={guide.id} delay={0.4 + index * 0.1}>
              <div className="col-span-12 md:col-span-6 lg:col-span-4">
                <div className="space-y-6 text-center">
                  <div className="mx-auto">
                    <span className={`${guide.icon} text-secondary dark:text-accent text-[52px]`}> </span>
                  </div>
