          ...
          <div className="grid grid-cols-12 items-start gap-y-12 lg:gap-8">
            <RevealAnimation delay={0.5}>
              <div className="col-span-12 lg:col-span-5 xl:col-span-6">
                <div>
                  <article className="dark:bg-background-8 mx-auto max-w-[627px] scale-100 overflow-hidden rounded-[20px] bg-white transition-transform duration-500 hover:scale-[102%] hover:transition-transform hover:duration-500 lg:mx-0 lg:max-w-full">
                    ...
                    <div className="p-8">
                      ...
                      <div className="mt-4 space-y-4">
                        <Link href={`/blog/${blogs[0].slug}`} className="block">
                          <h3 className="text-heading-6 md:text-heading-5 line-clamp-1">{blogs[0].title}</h3>
                        </Link>
                        <p className="line-clamp-2 w-full max-w-[563px]">{blogs[0].description}</p>
                      </div>
            ...
            <div className="col-span-12 space-y-8 lg:col-span-7 xl:col-span-6">
              <RevealAnimation delay={0.6}>
                <div>
                  <article className="dark:bg-background-8 mx-auto flex max-w-[627px] scale-100 flex-col gap-0 overflow-hidden rounded-[20px] bg-white transition-transform duration-500 hover:scale-[102%] hover:transition-transform hover:duration-500 sm:flex-row sm:gap-8 lg:mx-0 lg:max-w-full">
                    ...
                    <div className="space-y-4 p-8 sm:p-0 sm:py-8 sm:pr-8">
                      ...
                      <div className="space-y-4">
                        <Link href={`/blog/${blogs[1].slug}`} className="block">
                          <h3 className="text-heading-6 md:text-heading-5 line-clamp-2">{blogs[1].title}</h3>
                        </Link>
                      </div>
                      <div>
                        <LinkButton
                ...
                <div>
                  <article className="dark:bg-background-8 mx-auto flex max-w-[627px] scale-100 flex-col gap-0 overflow-hidden rounded-[20px] bg-white transition-transform duration-500 hover:scale-[102%] hover:transition-transform hover:duration-500 sm:flex-row sm:gap-8 lg:mx-0 lg:max-w-full">
                    ...
                    <div className="space-y-4 p-8 sm:p-0 sm:py-8 sm:pr-8">
                      ...
                      <div className="space-y-4">
                        <Link href={`/blog/${blogs[2].slug}`} className="block">
                          <h3 className="text-heading-6 md:text-heading-5 line-clamp-2">{blogs[2].title}</h3>
                        </Link>
                      </div>
                      <div>
                        <LinkButton
