...
const Reviews = () => {
  return (
    <section className="bg-background-2 dark:bg-background-6 relative py-20 pt-14 pb-14 sm:py-[100px] md:pt-16 md:pb-16 lg:py-[150px] lg:pt-[88px] lg:pb-[88px] xl:pt-[100px] xl:pb-[100px]">
      <div className="main-container flex flex-col gap-[70px] max-[426px]:gap-10">
        <div className="flex flex-col items-center text-center">
          <RevealAnimation delay={0.1}>
            <span className="badge mb-5 hidden">Customer Success</span>
          </RevealAnimation>
              ...
              <div className="swiper-wrapper">
                {reviews.map((review) => (
                  <SwiperSlide key={review.id} className="swiper-slide">
                    <div className="dark:bg-background-5 relative z-0 mx-1 flex flex-col gap-y-8 overflow-hidden rounded-[20px] bg-white p-8 sm:mx-0">
