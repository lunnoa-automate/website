...
const BlogCardV2 = ({ blog }: BlogCardV2Props) => {
  return (
    <article className="group">
      <div className="dark:bg-background-6 flex max-h-[308px] scale-100 flex-col items-center rounded-[20px] bg-white transition-transform duration-500 group-hover:scale-[101%] group-hover:transition-transform group-hover:duration-500 md:flex-row xl:gap-x-8">
        {/* blog img  */}
